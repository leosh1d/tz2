...
Данный проект интегрирован с GitHub Actions для автоматического запуска тестов при каждом пуше в репозиторий. Статус сборки и тестов можно посмотреть по бэйджу:
